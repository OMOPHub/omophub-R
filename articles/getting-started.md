...
returns the OMOPHub FHIR Terminology Service base URL so you can talk to
it directly with `httr2` or `fhircrackr`. Supports FHIR versions `"r4"`
...
mapping quality). Use
[`omophub_fhir_url()`](https://omophub.github.io/omophub-R/reference/omophub_fhir_url.md) +
`httr2` when you need FHIR-native responses for FHIR-native tooling.
